...
apt-get -y install php7.0 libapache2-mod-php7.0 php7.0-curl php7.0-gd php7.0-mcrypt php7.0-intl php7.0-sqlite3 php7.0-mysql php7.0-pgsql php7.0-dev php7.0-bz2 wget nano
INSTALL_SUCCESS=$?
